...
import { pricingSheet } from "./sailings";
...
export const invitation: InvitationConfig = {
  ...
  // ------------------------------------------------------------------
  hero: {
    image: "/images/icon-details.jpg", // Replace with "/images/quinceanera.jpg"
  ...
  // ⚠️ The sailing list is NOT in this file. It moved to
  //    src/data/sailings.ts because it is shared with the public
  //    marketing page (/quince-cruises) — it is not family-specific,
  //    and editing an invitation must never change it.
  //    Add or retire a sailing there; edit prices in the Google Sheet.
  // ------------------------------------------------------------------
  pricingSheet,
